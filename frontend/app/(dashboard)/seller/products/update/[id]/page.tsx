...
export default function UpdateProductPage() {
    ...
    return (
        <>
            <h1 className="text-xl font-semibold flex items-center gap-3"><ArrowLeft className="cursor-pointer" onClick={handleGoBack}/> Edit Product Details</h1>
            <p className="text-gray-500 mt-2 mb-5">Edit the details of your product.</p>
            <div className="p-4 rounded bg-white border my-5">
                ...
                <div className="grid my-4">
                    ...
                    <input type="text" value="Samsung galaxy s22 ultra" id="prdTitle" className="border rounded p-2" placeholder="Custom title for search engines"/>
                </div>
                <div className="grid my-4">
                    <label htmlFor="prodDesc" className="font-semibold mb-2">Description <span className="text-red-600 ml-2">*</span></label>
                    <textarea rows={4} value="This page is just to made for show ! without API data, this is noting but a template. Voila ! New product page and update page are almost similar for now. - Muneem" id="prodDesc" className="border rounded p-2" placeholder="Custom description for search engines"/>
                </div>

                <ImageUploader/>
                <p className="text-gray-500 my-3 text-center text-xs sm:text-sm">Upload up to 4 Images, First Image will be he product thumbnail</p>
